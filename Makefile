...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Mar 29 16:13:00 2014
...
SOURCES       = main.cpp \
		...
		gtask.cpp \
		gtasklist.cpp \
		gtaskhelper.cpp moc_dialog.cpp \
		moc_oauth2.cpp \
		moc_logindialog.cpp \
		moc_gtask.cpp \
		moc_gtasklist.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/test_oauth1.0.0/ && $(COPY_FILE) --parents dialog.h oauth2.h logindialog.h qtjson/json.h gtask.h gtasklist.h gtaskhelper.h .tmp/test_oauth1.0.0/ && $(COPY_FILE) --parents main.cpp dialog.cpp oauth2.cpp logindialog.cpp qtjson/json.cpp gtask.cpp gtasklist.cpp gtaskhelper.cpp .tmp/test_oauth1.0.0/ && $(COPY_FILE) --parents dialog.ui .tmp/test_oauth1.0.0/ && (cd `dirname .tmp/test_oauth1.0.0` && $(TAR) test_oauth1.0.0.tar test_oauth1.0.0 && $(COMPRESS) test_oauth1.0.0.tar) && $(MOVE) `dirname .tmp/test_oauth1.0.0`/test_oauth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/test_oauth1.0.0
...
compiler_moc_header_make_all: moc_dialog.cpp moc_oauth2.cpp moc_logindialog.cpp moc_gtask.cpp moc_gtasklist.cpp moc_gtaskhelper.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dialog.cpp moc_oauth2.cpp moc_logindialog.cpp moc_gtask.cpp moc_gtasklist.cpp moc_gtaskhelper.cpp
moc_dialog.cpp: oauth2.h \
		qtjson/json.h \
		dialog.h
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) dialog.h -o moc_dialog.cpp

moc_oauth2.cpp: qtjson/json.h \
		oauth2.h
...
moc_gtask.cpp: gtask.h
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) gtask.h -o moc_gtask.cpp

moc_gtasklist.cpp: gtasklist.h
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) gtasklist.h -o moc_gtasklist.cpp

moc_gtaskhelper.cpp: gtasklist.h \
		gtaskhelper.h
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) gtaskhelper.h -o moc_gtaskhelper.cpp
...
json.o: qtjson/json.cpp qtjson/json.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o json.o qtjson/json.cpp

gtask.o: gtask.cpp gtask.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gtask.o gtask.cpp

gtasklist.o: gtasklist.cpp gtasklist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gtasklist.o gtasklist.cpp

gtaskhelper.o: gtaskhelper.cpp gtaskhelper.h \
		gtasklist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gtaskhelper.o gtaskhelper.cpp
...
moc_gtask.o: moc_gtask.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_gtask.o moc_gtask.cpp

moc_gtasklist.o: moc_gtasklist.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_gtasklist.o moc_gtasklist.cpp

moc_gtaskhelper.o: moc_gtaskhelper.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_gtaskhelper.o moc_gtaskhelper.cpp
