...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Feb 13 21:41:50 2014
...
SOURCES       = main.cpp \
		...
		oauth2.cpp \
		logindialog.cpp \
		qtjson/json.cpp moc_dialog.cpp \
		moc_oauth2.cpp \
		moc_logindialog.cpp
OBJECTS       = main.o \
		dialog.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/test_oauth1.0.0/ && $(COPY_FILE) --parents dialog.h oauth2.h logindialog.h qtjson/json.h .tmp/test_oauth1.0.0/ && $(COPY_FILE) --parents main.cpp dialog.cpp oauth2.cpp logindialog.cpp qtjson/json.cpp .tmp/test_oauth1.0.0/ && $(COPY_FILE) --parents dialog.ui .tmp/test_oauth1.0.0/ && (cd `dirname .tmp/test_oauth1.0.0` && $(TAR) test_oauth1.0.0.tar test_oauth1.0.0 && $(COMPRESS) test_oauth1.0.0.tar) && $(MOVE) `dirname .tmp/test_oauth1.0.0`/test_oauth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/test_oauth1.0.0
